"""Textual UI for Lynx Consumer Staples Analysis."""
...
class ExplainModal(ModalScreen):
    ...
    def compose(self) -> ComposeResult:
        from lynx_staples.metrics.explanations import (
...
class LynxStaplesApp(PagingAppMixin, App):
    TITLE = "Lynx Consumer Staples Analysis"
    SUB_TITLE = "Consumer Staples Fundamental Analysis"
    CSS = """
    #search-dialog {
        width: 60;
        height: auto;
    ...
    def compose(self) -> ComposeResult:
        yield Header()
        yield Static(
            "[bold blue]  lynx-staples  [/]\n\n"
            "[bold]Consumer Staples Analysis Tool[/]\n"
    ...
    def action_cycle_theme(self) -> None:
        from lynx_staples.tui.themes import THEME_NAMES
    ...
    def action__ee_lynx(self) -> None:
        from lynx_staples.easter import LYNX_ASCII, WOLF_ASCII, BULL_ASCII
        import random
