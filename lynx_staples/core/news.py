"""News fetching for consumer staples companies (shim over :mod:`lynx_investor_core.news`).

Pre-binds the consumer-staples-specific sector keyword so call sites can invoke
...
from lynx_staples import NEWS_SECTOR_KEYWORD, USER_AGENT_PRODUCT
