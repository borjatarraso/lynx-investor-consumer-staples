...
Binds the consumer-staples-specific User-Agent product identifier and wires the agent's
...
from lynx_staples import USER_AGENT_PRODUCT
from lynx_staples.models import Filing
