"""Tkinter graphical user interface for Lynx Consumer Staples Analysis."""
...
from lynx_staples.models import AnalysisReport, CompanyStage, CompanyTier, Relevance, Severity
...
class SplashScreen:
    ...
    def __init__(self, root: tk.Tk, on_done: callable) -> None:
        ...
        self.subtitle = tk.Label(
            center, text="Consumer Staples Analysis", font=FONT_SPLASH_SUB,
            bg=BG, fg=ACCENT,
        )
        ...
        # Version
        from lynx_staples import __version__, __year__, __author__, SUITE_LABEL
...
class LynxStaplesGUI:
    """Tkinter GUI application for Lynx Consumer Staples Analysis."""
    ...
    def __init__(self, cli_args) -> None:
        ...
        self.root = tk.Tk()
        self.root.title("Lynx Consumer Staples Analysis")
    ...
    def _after_splash(self) -> None:
        ...
        from lynx_staples.tui.themes import HOUSE_THEMES as _HOUSE_THEMES
        from lynx_investor_core.gui_themes import register_gui_themes
        register_gui_themes(*_HOUSE_THEMES)
        self._theme_cycler = ThemeCycler(self.root, start="staples-dark")
    ...
    def _build_toolbar(self) -> None:
        ...
        tk.Label(
            brand, text="Lynx Consumer Staples", font=(_FAMILY, 14, "bold"),
    ...
    def _show_themes_menu(self) -> None:
        ...
        sector_family = ["staples-dark", "staples-light"]
    ...
    def _show_controls(self) -> None:
        ...
        self._show_info_popup(
            ...
            "lynx-staples -- Graphical Interface",
            sections,
        )

    def _on_about(self) -> None:
        from lynx_staples import get_about_text
        about = get_about_text()

        win = tk.Toplevel(self.root)
        win.title("About lynx-staples")
        win.configure(bg=BG)
    ...
    def _ee_shake(self) -> None:
        from lynx_staples.easter import tk_fireworks
        tk_fireworks(self.root)

    def _ee_rainbow(self) -> None:
        from lynx_staples.easter import tk_rainbow_title
        tk_rainbow_title(self.root)

    def _ee_fortune(self) -> None:
        from lynx_staples.easter import FORTUNE_QUOTES
        import random
    ...
    def _run_analysis(self, identifier: str) -> None:
        try:
            ...
            from lynx_staples.core.storage import is_testing
    ...
    def _render_sector_industry(self, r: AnalysisReport) -> None:
        from lynx_staples.metrics.sector_insights import get_sector_insight, get_industry_insight
    ...
    def _render_valuation(self, r: AnalysisReport) -> None:
        ...
        from lynx_staples.display import (
    ...
    def _render_screening(self, r: AnalysisReport) -> None:
        """Render the 10-point consumer staples screening checklist."""
    ...
    def _show_section_info(self, section_key: str) -> None:
        from lynx_staples.metrics.explanations import get_section_explanation
    ...
    def _show_conclusion_info(self, category: str = "overall") -> None:
        from lynx_staples.metrics.explanations import get_conclusion_explanation
...
def run_gui(args) -> None:
    ...
    app = LynxStaplesGUI(cli_args=args)
    app.run()
