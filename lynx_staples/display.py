"""Rich console display for consumer-staples analysis reports — stage and tier aware.
...
# ---------------------------------------------------------------------------
# Assessment functions — all return meaningful text for consumer-staples context
# ---------------------------------------------------------------------------
...
def _a_evrev(val):
    ...
    if val < 3.0:
        return "[yellow]Fair for consumer staples[/]"
    if val < 6.0:
...
def _a_gm(val):
    ...
    if val < 0.40:
        return "[yellow]Adequate gross margin for consumer staples[/]"
    if val < 0.55:
...
def _display_header(report):
    ...
    console.print(Panel(
        header,
        title="[bold]LYNX Consumer Staples Analysis[/]",
        border_style="blue",
    ))
...
def _display_screening(c):
    ...
    t = Table(title="Consumer Staples Screening Checklist", border_style="cyan")
...
def _display_market_intelligence(report):
    ...
    if mi.disclaimers:
        console.print(Panel(
            ...
            title="[dim]Consumer Staples Disclaimers[/]",
            border_style="dim",
        ))
