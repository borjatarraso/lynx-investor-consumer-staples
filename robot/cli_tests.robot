*** Settings ***
Documentation    CLI integration tests for lynx-staples
Library          Process
...
Given The Application Is Available
    Run App    --version
    Should Contain    ${OUTPUT}    lynx-staples
...
Show Help
    ...
    Then The Output Should Contain "lynx-staples"
...
Show About
    ...
    When I Run About
    Then The Exit Code Should Be 0
    Then The Output Should Contain "Lynx Consumer Staples Analysis"
...
Explain A Staples-Specific Metric
